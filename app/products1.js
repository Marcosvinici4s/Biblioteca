...
import listProducto from './products.json';
import imageMappings from './imageMappings';

export default function Books() {
    const halfIndex = Math.ceil(list.listProducto.length / 2);
    const firstHalf = listProducto.listProducto.slice(0, halfIndex);
    const secondHalf = listProducto.listProducto.slice(halfIndex);
